...
{
   1: { db: "db1", name: "Teja", username: "Putta", email: "chingchang@web.ccc", address: { street: "kajipet",  suite: "suite 123", city: "Rajpet", zipcode: "234-345" },

         phone: "3456780324", website: "webpage.org", company: { name: "oracle" } },
        
    2: { db: "db2", name: "Raj", username: "Kottu", email: "venkipinki@web.ccc", address: { street: "ringroad",  suite: "suite 345", city: "Kajipet", zipcode: "456-345" },

         phone: "34567803456", website: "redgh.org", company: { name: "TCs" } },
               
    3: { db: "db3", name: "rut", username: "singha", email: "chinguma@web.ccc", address: { street: "pallu",  suite: "suite 678", city: "rampur", zipcode: "987-345" },
...
// central router database
 ...
 module.exports = { central, vault, dbs };
